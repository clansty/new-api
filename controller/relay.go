...
func shouldRetry(c *gin.Context, openaiErr *types.NewAPIError, retryTimes int) bool {
	...
	if service.ShouldSkipRetryByKeyword(openaiErr.Error()) {
		return false
	}
...
func processChannelError(c *gin.Context, channelError types.ChannelError, err *types.NewAPIError) {
	...
	if service.ShouldDisableChannelForRequest(c, err) && channelError.AutoBan {
		gopool.Go(func() {
...
func RelayTask(c *gin.Context) {
	...
	if taskErr == nil {
		...
		task.PrivateData.BillingTokenId = relayInfo.GetBillingTokenId()
...
func shouldRetryTaskRelay(c *gin.Context, channelId int, taskErr *dto.TaskError, retryTimes int) bool {
	...
	if service.ShouldSkipRetryByKeyword(taskErr.Message) {
		return false
	}
	if service.ShouldSkipRetryAfterChannelAffinityFailure(c) {
		return false
